 ...
 */
function temperatureInF(t, u = "F" | "C") {
    return (t - 32) / 1.8;
}
...
console.log(makePersonObject(6, "Liam", "liam@gmail.com"));

let liam = makePersonObject(6, "Liam", "liam@gmail.com");
...
console.log(getCarInfoByIndex(inven, 5));
...
console.log(getLastCarInfo(inven));
...
function getModelYears(inven) {
    ...
    for (let i = 0; i < inven.length; i++) {
        x.push(inven[i].car_year);
    }
    return x;
}

console.log(getModelYears(inven));
